...
async function main() {
  const outputDir = join(process.cwd(), 'dogfood-output', 'scout-20260622', 'screenshots');
  ...
  serverProc.kill();
  console.log(`Screenshots captured successfully inside dogfood-output/scout-20260622/screenshots/`);
}
