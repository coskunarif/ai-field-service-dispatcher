...
for (const file of files) {
  ...
  if (!content.includes('href="/rsl.xml"')) {
    ...
    if (headEnd !== -1) {
      content = content.slice(0, headEnd) + '  <link rel="license" type="application/rsl+xml" href="/rsl.xml">\n' + content.slice(headEnd);
    }
  }
  ...
  if (tradeMap[nameWithoutExt]) {
    ...
    if (heroCopyStart !== -1) {
      ...
      if (nextParagraphStart !== -1 && nextParagraphEnd !== -1 && nextParagraphStart < content.indexOf('<form', heroCopyStart)) {
