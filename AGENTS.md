...
- **How:**
  ...
  - _Example:_ [geo-generator.spec.js](file:///home/ubuntuadmin/projects/ai-field-service-dispatcher/tests/geo-generator.spec.js)
...
- **How:**
  ...
  - _Example:_ [calendar_validation.spec.js](file:///home/ubuntuadmin/projects/ai-field-service-dispatcher/tests/calendar_validation.spec.js) and [wizard_resume.spec.js](file:///home/ubuntuadmin/projects/ai-field-service-dispatcher/tests/wizard_resume.spec.js)
...
- **How:**
  ...
  - _Example:_ [sandbox_simulator.spec.js](file:///home/ubuntuadmin/projects/ai-field-service-dispatcher/tests/sandbox_simulator.spec.js)
...
- **How:**
  ...
  - _Example:_ [gainhelm.spec.js](file:///home/ubuntuadmin/projects/ai-field-service-dispatcher/tests/gainhelm.spec.js) and [seo_conversion.spec.js](file:///home/ubuntuadmin/projects/ai-field-service-dispatcher/tests/seo_conversion.spec.js)
...
From a fresh clone, install dependencies and start the local server:
...
The repository uses ESLint, Prettier, and Husky/lint-staged pre-commit hooks to keep code consistent and catch issues before they reach CI.
...
npm run audit:tech-debt # scan TODO/FIXME markers
```

Pre-commit hooks automatically run ESLint and Prettier on staged files. If a hook fails, fix the reported issues before committing.

### Naming Conventions

- Use `camelCase` for variables and functions.
- Use `PascalCase` for classes, types, and constructors.
- Use `UPPER_CASE` for constants and environment variables.
- Keep files under 500 lines and functions under 150 lines. Refactor early when thresholds are exceeded.

---

## 6. Avoiding the Integration Gap (Lessons Learned)
