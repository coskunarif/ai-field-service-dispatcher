...
<style>
  ...
  .term-line.llm { color: #34d399; }
  .term-line.db { color: #38bdf8; }
...
<script>
  ...
  async function sendPhoneMessage(event) {
    ...
    if (currentState === 'waiting_sarah') {
      ...
      await delay(150);
      if (upperText === 'YES') {
        appendPhoneMessage('<strong>Gainhelm Dispatcher:</strong><br>Job confirmed! Scheduled in Google Calendar. Navigate to 123 Main St: <a href="https://maps.google.com/?q=123+Main+St" target="_blank" style="color: #34d399; font-weight: 600;">maps.google.com</a>', 'received');
