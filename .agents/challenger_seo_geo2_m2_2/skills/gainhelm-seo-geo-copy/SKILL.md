...
description: Use when improving Gainhelm landing-page SEO/GEO copy, crawl surfaces,
  metadata, internal links, Search Console checks, or conservative no-feature-claim
  marketing copy.
aliases: [gainhelm-seo-geo-copy]
---
